...
TileMapEx::TileMapEx(game& game)
    ...
    , _tileMapIso {{{
          ...
          {3, {.TextureRegion = "stone3", .Center = {0.5f, 0.25f}, .Height = -0.1f}},
          {4, {.TextureRegion = "stone4", .Center = {0.5f, 0.25f}, .Height = 0.0f}},
          {5, {.TextureRegion = "dirt1", .Center = {0.5f, 0.25f}, .Height = 0.2f}},
          ...
          {9, {.TextureRegion = "grass1", .Center = {0.5f, 0.25f}, .Height = 0.4f}},
